...
from BiLSTM_lipreader_function import *
...
# Make model
BiLSTMLipReaderModel, BiLSTMEncoder, fileNamePre = BiLSTM_lipreader(hiddenDim=hiddenDim,
...
class CheckSIAndMakePlots(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        [sil, sia] = BiLSTMLipReaderModel.evaluate_generator(gen_mouth_images(siDirs, batchSize=batchSize, shuffle=False, shuffleWords=False), siValSteps)
        ...
        BiLSTMLipReaderModel.save_weights(modelFilePath)
