...
def gen_mouth_images(allDirs, batchSize, align=False, reverseImageSequence=True, wordIdx=wordIdx,
                    wordsVocabSize=52, wordsPerVideo=6, framesPervid=75, framesPerWord=14, nOfMouthPixels=1600,
                    useMeanMouthImage=False, meanMouthImage=None, shuffle=True, shuffleWords=False, keepPadResults=False):
    np.random.seed(29)
