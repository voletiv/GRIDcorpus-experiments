...
# Load Mouth Images
def load_mouth_images(allDirs=None, mode="train", imagesDir=None, align=False, wordsVocabSize=52, wordIdx=wordIdx, wordsPerVideo=6, framesPerVid=75, framesPerWord=14, nOfMouthPixels=1600,
